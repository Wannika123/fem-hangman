...
export default function HowToPlay() {
    return (
        <div className={styles.container}>
            <h1 className='gradient-text large'>How to Play</h1>
            <div className={styles['rules-container']}>
                <div className={styles.rule}>
                    <h2>01 <span className={`${styles['rule-header']} ${styles['mobile-only']}`}>Choose a category</span></h2>
                    <div>
                        <h3 className={`${styles['rule-header']} ${styles['not-mobile']}`}>Choose a category</h3>
                        <p>
                ...
                <div className={styles.rule}>
                    <h2>02 <span className={`${styles['rule-header']} ${styles['mobile-only']}`}>Guess letters</span></h2>
                    <div>
                ...
                <div className={styles.rule}>
                    <h2>03 <span className={`${styles['rule-header']} ${styles['mobile-only']}`}>Win or lose</span></h2>
                    <div>
                        <h3 className={`${styles['rule-header']} ${styles['not-mobile']}`}>Win or lose</h3>
                        <p>
